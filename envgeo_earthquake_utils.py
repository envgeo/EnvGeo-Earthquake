...
# -*- coding: utf-8 -*-
"""
Shared utilities and Streamlit renderers for EnvGeo-Earthquake.

This module contains the implementation previously embedded in
``pages/55_4D_Visualizer_Earthquake_Advanced.py`` so that other pages,
especially the JMA/NIED comparison page, can import the same earthquake
functions without loading a Streamlit page file by path.
"""
